...
namespace ZendureShellShared
{
    public static class ZendureStatics
    {
        ...
        private static readonly string APP_HOSTNAME = "app.zendure.tech/eu";
       // private static readonly string APP_HOSTNAME_US = "app.zendure.tech";
        ...
        public static readonly string APP_DETAILS_URL =     $"https://{APP_HOSTNAME}/{APP_DETAIL_PATH}";
        public static readonly string APP_DEVELOPER_URL =   $"https://{APP_HOSTNAME}/{APP_DEVELOPER_PATH}";
